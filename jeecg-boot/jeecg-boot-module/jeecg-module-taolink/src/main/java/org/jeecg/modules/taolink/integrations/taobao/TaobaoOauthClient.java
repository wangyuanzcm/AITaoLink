...
public class TaobaoOauthClient {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TaobaoOauthClient.class);
    ...
    private void assertConfigured() {
        if (oConvertUtils.isEmpty(appKey) || oConvertUtils.isEmpty(appSecret) || oConvertUtils.isEmpty(redirectUri)) {
            throw new IllegalStateException("请先配置 taolink.taobao.appKey / taolink.taobao.appSecret / taolink.taobao.redirectUri");
        }
    }
